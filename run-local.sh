...
# lets ONE deployment serve both: an org whose LLM nodes ask for `gpt-5.6-luna` goes out to
...
HOSTED_OPENAI_MODELS="${HOSTED_OPENAI_MODELS:-gpt-5.6-luna gpt-5.6-terra gpt-5.6-sol gpt-5 gpt-5-mini gpt-5-nano}"
