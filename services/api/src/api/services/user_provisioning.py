"""Auto-provision UserProfile records on first Keycloak login."""
...
async def provision_user_from_claims(
    ...
    *,
    ...
    """Find or create a UserProfile for the given Keycloak subject.
    ...
    if profile is not None:
        # Keep email/username in sync with Keycloak
        changed = False
