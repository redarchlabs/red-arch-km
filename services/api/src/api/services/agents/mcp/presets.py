...
MCP_PRESETS: tuple[McpPreset, ...] = (
    McpPreset(
        ...
        None,
        True,
        "Sign in with your Linear account; dynamic registration.",
    ),
    McpPreset(
        "atlassian",
        ...
        None,
        True,
        "Authorize your Atlassian site (Jira/Confluence).",
    ),
    McpPreset(
        "github",
        "GitHub",
    ...
    McpPreset(
        ...
        None,
        True,
        "Authorize the Notion workspaces you want the agent to reach.",
    ),
    McpPreset(
        "sentry",
        "Sentry",
        ...
        None,
        True,
        "Authorize your Sentry organization.",
    ),
)
