...
export type LiveEvent =
  ...
  /** The run has stopped and is waiting on a person — an approval, a typed answer,
   *  or a peer. Distinct from a tool that is merely slow, which is what a parked run
